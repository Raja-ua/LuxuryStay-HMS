...
import { faBed, faUsers, faConciergeBell, faCalendarPlus, faClipboardList, faCommentDots, faChartLine, faDoorOpen, faMoneyBillWave, faBroom, faWrench, faUserTie, faSignInAlt, faSignOutAlt, faBell } from '@fortawesome/free-solid-svg-icons';
      ...
      const fetchStats = async () => {
        try {
          ...
          setStats({
            ...
            pendingBookings: kpis.pendingBookings || 0,
            todaysCheckIns: kpis.todaysCheckIns || 0,
            todaysCheckOuts: kpis.todaysCheckOuts || 0,
            pendingServiceRequests: kpis.pendingServiceRequests || 0,
            cleaningRooms: kpis.roomsToClean || 0,
            maintenanceRooms: kpis.maintenanceRooms || 0,
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-500 text-sm font-semibold uppercase tracking-wider mb-1">Pending Bookings</p>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-500 text-sm font-semibold uppercase tracking-wider mb-1">Today's Check-ins</p>
                <h3 className="text-2xl font-bold text-gray-800">{stats.todaysCheckIns}</h3>
              </div>
            </div>

            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
              <div className="w-14 h-14 bg-teal-100 text-teal-600 rounded-xl flex items-center justify-center text-2xl">
                <FontAwesomeIcon icon={faSignOutAlt} />
              </div>
              <div>
                <p className="text-gray-500 text-sm font-semibold uppercase tracking-wider mb-1">Today's Check-outs</p>
                <h3 className="text-2xl font-bold text-gray-800">{stats.todaysCheckOuts}</h3>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-500 text-sm font-semibold uppercase tracking-wider mb-1">Pending Services</p>
                <h3 className="text-2xl font-bold text-gray-800">{stats.pendingServiceRequests}</h3>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-500 text-sm font-semibold uppercase tracking-wider mb-1">Rooms to Clean</p>
